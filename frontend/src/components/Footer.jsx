      ...
      <div className="mx-auto mt-10 max-w-7xl border-t border-white/10 px-margin-mobile pt-8 md:px-margin-desktop">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-5">
            <a href="https://www.facebook.com/FuegoUgandaLimited" target="_blank" rel="noopener noreferrer" aria-label="Facebook - Fuego Uganda Limited" onClick={(e) => { e.stopPropagation(); }} className="flex h-14 w-14 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-white text-[#1d1d1d] shadow-md transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-lg">
            ...
            <a href="https://www.youtube.com/@FuegoUgandaLimited" target="_blank" rel="noopener noreferrer" aria-label="YouTube - Fuego Uganda Limited" onClick={(e) => { e.stopPropagation(); }} className="flex h-14 w-14 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-white text-[#1d1d1d] shadow-md transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-lg">
              <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current pointer-events-none" aria-hidden="true">
            ...
            <a href="https://www.instagram.com/FuegoUgandaLimited" target="_blank" rel="noopener noreferrer" aria-label="Instagram - Fuego Uganda Limited" onClick={(e) => { e.stopPropagation(); }} className="flex h-14 w-14 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-white text-[#1d1d1d] shadow-md transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-lg">
              <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current pointer-events-none" aria-hidden="true">
            ...
            <a href="https://x.com/FuegoUgandaLtd" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter) - Fuego Uganda Limited" onClick={(e) => { e.stopPropagation(); }} className="flex h-14 w-14 sm:h-12 sm:w-12 items-center justify-center rounded-lg bg-white text-[#1d1d1d] shadow-md transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-lg">
              <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current pointer-events-none" aria-hidden="true">
